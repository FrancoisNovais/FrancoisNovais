...
- **[BlaBlaBook](https://github.com/BlaBlaBook)** – Team project: fullstack web app to share, rate and discover books. React + TypeScript frontend, Node.js/Express + TypeScript backend with PostgreSQL. Built collaboratively with Git workflow (branches, pull requests, code reviews).  
  → [Frontend](https://github.com/BlaBlaBook/projet-blablabook-front) · [Backend](https://github.com/BlaBlaBook/projet-blablabook-back)
- **ChatForge** – Front-end single-page application integrating PocketBase for data management and an AI API for smart conversations.
